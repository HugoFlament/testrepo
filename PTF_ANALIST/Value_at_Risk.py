...
class PageTwo(wx.Panel):
    ...
    def myListener(self, arg1, arg2, arg3, arg4):
        ...
        figure_1.hist(returns[stocks_2[0]], bins=50, normed=True, histtype='stepfilled', alpha=0.5)
        figure_1.hist(returns[stocks_2[1]], bins=50, normed=True, histtype='stepfilled', alpha=0.5)
        figure_1.hist(returns[stocks_2[2]], bins=50, normed=True, histtype='stepfilled', alpha=0.5)
        figure_1.hist(returns[stocks_2[3]], bins=50, normed=True, histtype='stepfilled', alpha=0.5)
        figure_1.hist(portfolio_2["Portfolio"].dropna(), bins=50, normed=True, histtype='stepfilled', alpha=0.5)
        figure_1.set_title(u"Historic return distribution", weight='bold')
        figure_1.legend(loc='upper left')
        figure_1.plot(grid = True)
